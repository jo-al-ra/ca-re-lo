...
interface VirtualBaseRegistrarInterface extends ethers.utils.Interface {
  functions: {
...
export class VirtualBaseRegistrar extends BaseContract {
  ...
  interface: VirtualBaseRegistrarInterface;
