...
interface CareloRegistrarInterface extends ethers.utils.Interface {
  functions: {
    ...
    "transferEntity(address,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "transferEntity",
    values: [string, string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export class CareloRegistrar extends BaseContract {
  ...
  interface: CareloRegistrarInterface;
  ...
  functions: {
    ...
    "transferEntity(address,address,uint256)"(
      from: string,
      to: string,
      id: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    "transferEntity(address,address,uint256,string)"(
      from: string,
      to: string,
      id: BigNumberish,
      newURL: string,
